...
const stats = [
  { value: 2500, suffix: "+", label: "PGs Listed", icon: Building },
  { value: 15000, suffix: "+", label: "Happy Residents", icon: Users },
  { value: 50, suffix: "+", label: "Cities Covered", icon: MapPin },
  { value: 98, suffix: "%", label: "Accuracy Rate", icon: Shield },
];
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          >
            <div className="relative">
              ...
              {/* Floating cards */}
              <motion.div
                className="absolute -bottom-6 -left-6 glass-card rounded-xl p-4 animate-float"
              >
              ...
              <motion.div
                className="absolute -top-4 -right-4 glass-card rounded-xl p-3 animate-float-delayed"
              >
            ...
            >
              ...
              <div className="p-5">
                ...
                <div className="mt-4 flex items-center justify-between">
                  <span className="text-xl font-extrabold text-foreground">{pg.price}<span className="text-sm font-normal text-muted-foreground">/mo</span></span>
                  <Link to={`/pg/${pg.name.toLowerCase().replace(/\s+/g, '-')}`}>
